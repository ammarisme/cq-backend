...
# WARNING: Ensure imports from `cq_backend` comes after this line
from cq_backend import app, settings, db  # noqa
from cq_backend.cli import create_user, cli  # noqa
